...
```{r intervention impact analysis data preparation, echo=TRUE, warning=FALSE}
...
```{r intervention impact evaluation -- checking for confounders, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r intervention impact evaluation -- final results, echo=TRUE, warning=FALSE}
